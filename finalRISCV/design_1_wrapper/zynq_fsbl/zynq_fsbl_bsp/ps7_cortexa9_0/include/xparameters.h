...
/* Definitions for peripheral AXI_GPIO_ALU */
#define XPAR_AXI_GPIO_ALU_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_ALU_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_ALU_DEVICE_ID 0
#define XPAR_AXI_GPIO_ALU_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_ALU_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_INST */
#define XPAR_AXI_GPIO_INST_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_INST_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_INST_DEVICE_ID 1
#define XPAR_AXI_GPIO_INST_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_INST_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_PC */
#define XPAR_AXI_GPIO_PC_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_PC_HIGHADDR 0x4122FFFF
#define XPAR_AXI_GPIO_PC_DEVICE_ID 2
#define XPAR_AXI_GPIO_PC_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_PC_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_ALU */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_ALU_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_INST */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_INST_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_PC */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_PC_DEVICE_ID
